...
public sealed class ProtoWriter : IDisposable
{
    ...
    internal NetObjectCache NetCache { get; } = new();
    ...
    private static void CopyRawFromStream(Stream source, ProtoWriter writer)
    {
        ...
        if (bytesRead <= 0)
        {
            return; // all done using just the buffer; stream exhausted
        }
    ...
    private static SubItemToken StartSubItem(object instance, ProtoWriter writer, bool allowFixed)
    {
        ...
        switch (writer.WireType)
        {
            ...
            case WireType.Fixed32:
            {
                ...
                DemandSpace(32, writer); // make some space in anticipation...
                writer.flushLock++;
                var token = new SubItemToken((long)writer.ioIndex);
...
#pragma warning restore CS0618
    ...
    internal static Exception CreateException(ProtoWriter writer)
    {
        ...
        return new ProtoException("Invalid serialization operation with wire-type " + writer.WireType + " at position " + writer.position64);
    }
