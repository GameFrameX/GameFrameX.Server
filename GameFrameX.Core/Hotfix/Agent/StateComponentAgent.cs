...
namespace GameFrameX.Core.Hotfix.Agent
{
    ...
    public abstract class StateComponentAgent<TComponent, TState> : BaseComponentAgent<TComponent> where TComponent : StateComponent<TState> where TState : ICacheState, new()
    {
        /// <summary>
        /// 数据对象
        /// </summary>
