...
public class LoadBalancerStatistics
{
    ...
    /// 最小选择时间（毫秒）
    /// </summary>
    public double MinSelectionTimeMs { get; set; }

    /// <summary>
    /// 最大选择时间（毫秒）
    /// </summary>
    public double MaxSelectionTimeMs { get; set; }

    /// <summary>
    /// 每个实例的选择次数
    /// </summary>
    public Dictionary<long, long> SelectionsByInstance { get; set; } = new();

    /// <summary>
    /// 成功率
    /// </summary>
    public double SuccessRate => TotalSelections > 0 ? (double)SuccessfulSelections / TotalSelections * 100 : 100;
    ...
    public void Reset()
    {
        ...
        MinSelectionTimeMs = 0;
        MaxSelectionTimeMs = 0;
        SelectionsByInstance.Clear();
